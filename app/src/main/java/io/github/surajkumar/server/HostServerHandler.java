...
import io.github.surajkumar.server.screen.ScreenRecorder;
import io.github.surajkumar.server.screen.ScreenWatcher;
import io.github.surajkumar.server.screen.WatcherPermissions;
import io.github.surajkumar.server.actions.Action;
import io.github.surajkumar.server.actions.ActionHandler;
...
public class HostServerHandler implements Handler<NetSocket> {
    ...
    public HostServerHandler(int monitor) {
        try {
            this.recorder = new ScreenRecorder(30, Monitor.getBoundsForMonitor(monitor));
